...
extension UIView{
    func addConstraintsWithFormat(format:String, views: UIView...){
        //1. Initialize a new dictionairy (key: String, value: UIview)
        var viewsDictionary = [String:UIView]()
        for (index, view) in views.enumerated(){
            //2. create the kayvalue at each iteration
            let key = "v\(index)"
            //3. write values into viewsDictionary dictionary
            viewsDictionary[key] = view
            //4.enable the new constraints
